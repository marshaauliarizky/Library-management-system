    ...
    <div class="register-container">
        <div class="register-card">
            ...
            <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/admin-register" method="post" id="registerForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" required placeholder="yourname@librarysystem.com">
                    </div>
            ...
            <div class="card-footer">
                ...
                <a href="${pageContext.request.contextPath}/admin-login" class="login-link">Already have an account? Login</a>
            </div>
        </div>
    </div>
