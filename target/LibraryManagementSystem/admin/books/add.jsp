        ...
        <div class="content-section">
            ...
            <form action="${pageContext.request.contextPath}/admin/books" method="post">
                ...
                <div class="form-group">
                   ...
                   <textarea name="synopsis" id="synopsis" rows="4" cols="90">
                       <c:out value="${book != null ? book.synopsis : ''}" />
                   </textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="publicationYear" name="publicationYear" min="1000" max="2099"
                           value="${book != null ? book.publicationYear : ''}">
                </div>
                
                <div class="form-group">
                    <label for="totalCopies">Total Copies</label>
                    <input type="number" class="form-control" id="totalCopies" name="totalCopies" min="1" value="${book != null ? book.totalCopies : 1}" required>
                </div>
